...
public class MedicineAlertsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appDatabase = AppDatabase.getAppdatabase(MedicineAlertsActivity.this);
    ...
    public void addReminder() {
        ...
        dialog = new Dialog(MedicineAlertsActivity.this);
        ...
        select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog dialog = new DatePickerDialog(MedicineAlertsActivity.this, (view, year, month, dayOfMonth) -> {

                    final Calendar newDate = Calendar.getInstance();
                    Calendar newTime = Calendar.getInstance();
                    TimePickerDialog time = new TimePickerDialog(MedicineAlertsActivity.this, (view1, hourOfDay, minute) -> {
                        ...
                        if (newDate.getTimeInMillis() - tem.getTimeInMillis() > 0)
                            ...
                            Toast.makeText(MedicineAlertsActivity.this, "Invalid time", Toast.LENGTH_SHORT).show();
        ...
        add.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(MedicineAlertsActivity.this, NotifierAlarm.class);
            ...
            PendingIntent intent1 = PendingIntent.getBroadcast(MedicineAlertsActivity.this, reminders.getId(), intent, PendingIntent.FLAG_UPDATE_CURRENT);
            AlarmManager alarmManager = (AlarmManager) getSystemService(ALARM_SERVICE);
            alarmManager.setExact(AlarmManager.RTC_WAKEUP, calendar.getTimeInMillis(), intent1);

            Toast.makeText(MedicineAlertsActivity.this, "Inserted Successfully", Toast.LENGTH_SHORT).show();
